...
<?php
    /*
    klhsh apo index,page2
    
    Otan o xrhsths pataei to koumpi "Prosthikh sto kalathi"
    
    kaleitai o kwdikas pou ananewnei thn endeiksh ths katastashs kalathiou 
    sto header
    
    Ousiastika, to task to analambanei 
    h function echoCartMessage() - arxeio front_end_functions.php
    */
?>