...
<?php echo calcCartHeadAmountOrValue(2)?>

<?php
    /*
    klhsh apo page3
    
    Otan o xrhsths pataei to koumpi delete h edit
    
    kaleitai o kwdikas pou ypologizei to poso tou kalathiou
    
    Ousiastika, to task to analambanei 
    h function calcCartHeadAmountOrValue() - arxeio controller_functions.php
    */
?>